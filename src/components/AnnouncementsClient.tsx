...
export default function AnnouncementsClient({
  ...
  return (
    <section
      ...
      aria-label="School announcements of The EduGate School Mirpurkhas"
    >
      <div className="max-w-7xl mx-auto px-4">
        ...
        >
          <h2 className="text-3xl md:text-5xl font-extrabold text-gray-900">
            School Announcements & Updates – The EduGate School Mirpurkhas
          </h2>

          <p className="text-gray-600 mt-4 max-w-xl mx-auto">
            Stay informed with the latest school announcements, events, notices,
            and important updates from The EduGate School Mirpurkhas.
          </p>
        </motion.div>
